...
- `alive` - the name contains `claude`, `codex`, `opencode`, `grok`, or `agy`. `claude`, `codex`, `opencode`, and `grok` were confirmed to run as their own literal process name (`ps -ef`, 2026-07-07); `agy` was confirmed live under its own process name during the 2026-07-26 adapter verification.
