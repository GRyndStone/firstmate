...
The primary project hook runs `bin/fm-turnend-guard-grok.sh`, which durably records and schedules one bounded same-session follow-up after every Stop event that would still end blind.
