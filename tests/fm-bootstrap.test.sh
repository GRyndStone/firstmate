...
agy baked-effort model is accepted^{"rules":[{"when":"antigravity fallback","use":{"provider":"antigravity","harness":"agy","model":"gemini-3.1-pro-low"}}]}^grep^CREW_DISPATCH: active config/crew-dispatch.json
